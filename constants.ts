...
// Paste your Base64 string for the Company Logo here (Report & Sign Off)
export const COMPANY_LOGO_BASE64 = "";

// Paste your Base64 string for the Co-Branding/Partner Logo here
export const PARTNER_LOGO_BASE64 = "";
