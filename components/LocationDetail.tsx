...
import { compressImage, AutoResizeTextarea, DeleteConfirmationModal } from './SharedUtils';

// Re-export from SharedUtils for backward compatibility
export { compressImage, AutoResizeTextarea, DeleteConfirmationModal } from './SharedUtils';
